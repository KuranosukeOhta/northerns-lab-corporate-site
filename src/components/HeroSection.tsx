      ...
      <div className="relative p-8 md:p-16 max-w-6xl mx-4 w-full overflow-hidden" style={{ zIndex: 10 }}>
        <div className="relative z-20 text-center">
          ...
          <div className="mb-8 transform hover:scale-105 transition-transform duration-700">
            <h1 className="text-6xl sm:text-7xl md:text-8xl lg:text-[10rem] font-bold text-white leading-none drop-shadow-2xl hover:scale-110 transition-all duration-500 ease-out cursor-pointer" style={{ letterSpacing: '-0.03em' }}>
